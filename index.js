...
f=m=>{for(i=125;i<200;i++)j[i]=0;z=m;h=-1};

c.scale(t=Math.min(a.width/175,a.height/91),t);
setInterval(()=>{
	!k&&!p&&(j[h]=2,p=60);
	!(l%4)&&(g=h+s[k-5]||h,h=!j[g]?g:h);
	p&&(p--);
	...
	j.map((u,i)=>{
		...
		u==2&&p==1&&s.map(n=>(j[i+n]=j[i+n]-1?6:1,i+n==h&&f(1)));
		o(['','','406VYFBJMK','5E4I8C3K74','2S18HVN1KA','406NVLGBH0','368ZVO5G78'][i==h?5:u],[7*(i%25),7*~~(i/25)],u==1||u==2&&!(l%9))
	});
