...
setInterval(()=>{
	...
	j.forEach((u,i)=>{
		...
		u==2&&p==1&&s.forEach(n=>(j[i+n]=j[i+n]-1?0:1,i+n==h&&f(0)))
	});
	d.forEach(u=>(!j[u[1]]&&(j[u[1]]=3,j[u[0]]=0),u[1]==h&&f(0)));
	!m&&f(1);
	c.clearRect(0,0,875,455);
	j.forEach((u,i)=>o(['','','406VYFBJMK','5E4I8C3K74','2S18HVN1KA','406NVLGBH0'][i==h?5:u],[7*(i%25),7*~~(i/25)],u==1||u==2&&!(l%9)));
	z&&(c.fillText(w?'Win':'Lose',80,49));
	l++
},30)
